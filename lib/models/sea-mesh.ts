...
export class SeaMesh extends QuadSphereMesh {
    ...
    public get opacity() {
        return (this.material as MeshPhongMaterial).opacity;
    }
    public set opacity(value: number) {
        (this.material as MeshPhongMaterial).opacity = value;
    }
    ...
    public regenerateShading() {
        ...
        //     face.vertexColors =  [face.a, face.b, face.c].map(i => new Color('#000080'));
        // });
    }
